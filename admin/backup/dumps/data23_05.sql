...
-- Started on 2024-05-23 15:38:13
...
--
-- TOC entry 233 (class 1255 OID 24590)
...
begin
	...
	then
	  insert into client (nom,prenom,email,adresse,password) values
	    (p_nom,p_prenom,p_email,p_adresse,p_mdp);
	  select into id id_client from client where email = p_email;
	  if not found
	  then	
...
--
-- TOC entry 238 (class 1255 OID 24608)
-- Name: ajout_ticket(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ajout_ticket(integer, integer, integer) RETURNS integer
    LANGUAGE plpgsql
    AS 'declare p_client alias for $1;
  declare p_seance alias for $2;
  declare p_quantite alias for $3;
  declare id integer;
  declare retour integer;
  
begin
	select into id id_ticket from ticket where id_client = p_client and id_seance = p_seance;
	if not found
	then
	  insert into ticket (quantite,id_client,id_seance) values
	    (p_quantite,p_client,p_seance);
	  select into id id_ticket from ticket where id_client = p_client and id_seance = p_seance;
	  if not found
	  then	
	    retour = -1;  --échec de la requête
...
--
-- TOC entry 231 (class 1255 OID 24604)
...
--
-- TOC entry 232 (class 1255 OID 24607)
...
CREATE FUNCTION public.verifier_client(text, text) RETURNS integer
    LANGUAGE plpgsql
    AS 'DECLARE p_login ALIAS FOR $1;
  DECLARE p_pass ALIAS for $2;
  DECLARE id integer;
  DECLARE retour integer;
BEGIN
  select into id id_client from client where email = p_login and password = p_pass;
  IF NOT FOUND
  THEN
    retour = 0;
  ELSE
...
--
-- TOC entry 4835 (class 0 OID 24594)
-- Dependencies: 224
...
--
-- TOC entry 4829 (class 0 OID 16473)
-- Dependencies: 218
-- Data for Name: client; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.client (id_client, nom, prenom, email, adresse, password) OVERRIDING SYSTEM VALUE VALUES (13, 'Mendes', 'Alicia', 'a@a', 'on s''en fou ', '1234');
...
--
-- TOC entry 4826 (class 0 OID 16446)
-- Dependencies: 215
...
--
-- TOC entry 4828 (class 0 OID 16458)
-- Dependencies: 217
...
--
-- TOC entry 4830 (class 0 OID 16480)
-- Dependencies: 219
-- Data for Name: ticket; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.ticket (id_ticket, quantite, id_client, id_seance) OVERRIDING SYSTEM VALUE VALUES (1, 5, 13, 15);
...
--
-- TOC entry 4678 (class 2606 OID 24601)
...
--
-- TOC entry 4674 (class 2606 OID 16479)
...
--
-- TOC entry 4670 (class 2606 OID 16457)
...
--
-- TOC entry 4668 (class 2606 OID 16450)
...
--
-- TOC entry 4672 (class 2606 OID 16462)
...
--
-- TOC entry 4676 (class 2606 OID 16486)
...
--
-- TOC entry 4680 (class 2606 OID 16468)
...
--
-- TOC entry 4681 (class 2606 OID 16487)
...
ALTER TABLE ONLY public.ticket
    ADD CONSTRAINT ticket_id_sceance_fkey FOREIGN KEY (id_seance) REFERENCES public.seance(id_seance);


-- Completed on 2024-05-23 15:38:16
